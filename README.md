...
<ul>
  ...
  <li>💡 Passionate about extracting insights from data and building Predictive Models</li>
  <li>🤖 Currently deep-diving into **Machine Learning** and **Artificial Intelligence**</li>
  <li>🏗️ Learning the ropes of **Data Engineering** to build robust data pipelines</li>
  <li>📈 Experienced in creating interactive dashboards using **Power BI**</li>
  <li>🐍 Strong foundation in **Python** (Pandas, NumPy, Matplotlib, Seaborn) and **R**</li>
